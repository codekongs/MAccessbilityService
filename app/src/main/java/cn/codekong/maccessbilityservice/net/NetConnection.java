package cn.codekong.maccessbilityservice.net;
...
public class NetConnection {
    public NetConnection(final String url, final HttpMethod method, final HttpCallBackListener listener, final String[] header, final String paramsStr) {
